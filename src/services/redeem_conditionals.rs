...
pub async fn handle_redeem_conditional_tokens_tx(
    ...
    let mint_instruction = transactions::find_instruction(&transaction_payload, "redeemConditionalTokensForUnderlyingTokens")?;
    ...
    let relevant_accounts =
       transactions::get_relevant_accounts_from_mint_and_vault(&mint_instruction, conditional_vault);
